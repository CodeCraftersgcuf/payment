...
const Footer = () => {
  return (
    ...
    <div id="footer">
        <div>
        <h4 className="footer-div-h4">Useful Links</h4>
        <a href="#">Home</a>
            <a href="#">About US</a>
            <a href="#">Services</a>
        ...
        <div>
        <h4 className="footer-div-h4">Services</h4>
        <a href="">Web Design</a>
        ...
        <div>
        <h4 className="extrasmall:text-[14px] text-[18px]">SIGN UP FOR ALPHALETE NEWSLETTER</h4>
    ...
    <aside className='copyRight'>
        ...
        <span class="footer-last"><p>PRIVACY POLICY</p> <p>TERMS OF SERVICE</p> <p>SITEMAP</p> <p>DO NOT SELL OR SHARE MY PERSONAL INFORMATION</p></span>
    </aside>
    </>
  )
}
